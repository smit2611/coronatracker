...
public class AffectedCountries extends AppCompatActivity {
    ...
    public static List<CountryModel> informationList = new ArrayList<>();
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for(int i=0;i<jsonArray.length();i++){
                                ...
                                informationList.add(countryModel);
                            }


                            myCustomAdapter = new MyCustomAdapter(AffectedCountries.this,informationList);
